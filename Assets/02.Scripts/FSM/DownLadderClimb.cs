	...
	public class DownLadderClimb : CharacterStateBase
	{
		...
		public override bool canExecute => base.canExecute &&
			(machine.currentStateID == CharacterStateID.Idle ||
			 ...
			 controller.isLadderDownDetected &&
		...
		public override void OnStateEnter()
		{
			...
			Vector2 startPos = transform.position.y < _ladder.downEnter.y ? new Vector2(_ladder.downEnter.x, transform.position.y) : _ladder.downEnter; 
